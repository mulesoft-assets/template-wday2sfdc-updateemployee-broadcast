...
/**
 * This {@link org.mule.tck.probe.Probe} receives a {@link PipelineSynchronizeListener} as a parameter upon construction. It will check the readyToContinue method of the same to
